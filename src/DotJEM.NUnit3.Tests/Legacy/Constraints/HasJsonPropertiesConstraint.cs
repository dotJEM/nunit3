...
namespace DotJEM.NUnit3.Tests.Legacy.Constraints
{
    public class HasJsonPropertiesConstraintTest
    {
          ...
          public void ApplyTo_DeepObjects2_Fails()
        {
            ...
            Assert.That(result.ToString(), Is.EqualTo("  DotJEM.NUnit3.Legacy.Constraints.HasJsonPropertiesConstraint Failed!" +
                                                      "\r\n  Actual object did not contain a property named 'val.A.arr[0].number'" +
                                                      "\r\n  Actual object did not contain a property named 'val.A.arr[1].empty'" +
                                                      "\r\n  Actual object did not contain a property named 'val.B.arr[0].number'" +
                                                      "\r\n  Actual object did not contain a property named 'val.B.arr[1].empty'" +
                                                      "\r\n"));
        }
    }
}
